...
운영 문서를 상황별로 찾으려면 `docs/pilot-document-package-index.md`를 먼저 확인합니다. 파일럿 당일 운영 순서는 `docs/facilitator-pilot-runbook.md`를 먼저 확인합니다. UI/UX와 화면별 노출 기준은 `docs/pilot-ui-ux-qa-checklist.md`를 기준으로 점검합니다.
