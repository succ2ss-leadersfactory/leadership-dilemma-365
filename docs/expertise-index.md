...
- 최종 판정에는 약하게만 반영합니다.
- Markdown 리포트에는 일부 누적 해석 항목이 아직 제한적으로 반영되어 있습니다.
...
1. Markdown 다운로드에 누적 결과 해석과 경고 신호 추가
2. 누적 대가가 반복될 때 라운드별 원인 표시
3. 비밀 미션 기준에 전문성 증거 수준 조건 추가
4. 팀별 result narrative를 라운드별로 더 세분화
5. 실제 파일럿 산출물 기반으로 evidenceReview 키워드 보정
6. 전문성 QA 문서를 파일럿 최종 QA 판정표에 연결
